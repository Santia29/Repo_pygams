...
class Enemigo:
    ...
    def __init__(self, coord_x, coord_y, frame_rate = 100, speed_walk = 6, speed_run = 12, gravity = 16, jump = 32):
        self.__iddle_r = sf.get_surface_from_spritesheet('assets/img/enemigo/idle/idle.png', 16, 1)
        self.__iddle_l = sf.get_surface_from_spritesheet('assets/img/enemigo/idle/idle.png', 16, 1, flip=True)
        self.__walk_r = sf.get_surface_from_spritesheet('assets/img/enemigo/walk/walk.png', 1, 1)
        self.__walk_l = sf.get_surface_from_spritesheet('assets/img/enemigo/walk/walk.png', 1, 1, flip=True)
        self.__attack_r = sf.get_surface_from_spritesheet('assets/img/enemigo/attack/6_ATTACK_000.png', 1, 1)
        self.__attack_l = sf.get_surface_from_spritesheet('assets/img/enemigo/attack/6_ATTACK_000.png', 1, 1, flip=True)
        self.__jump_r = sf.get_surface_from_spritesheet('./assets/img/player/jump/player_jump.png', 6, 1, 1, False)
        self.__jump_l = sf.get_surface_from_spritesheet('./assets/img/player/jump/player_jump.png', 6, 1, 1 , flip=True)
    ...
    # #
    # def update(self):
    #     if(self.__frame_rate < len(self.__actual_animation) - 1):
    #         self.__frame_rate += 1
    #     else:
    #         self.__frame_rate = 0
    #         if(self.__is_jumping == True):
    #             self.__is_jumping = False
    #             self.__move_y = 0
